...
// build a free block bitmap, and prepare the filesystem for use. Return one on success, zero
// otherwise. Note that a successful mount is a pre-requisite for the remaining calls
